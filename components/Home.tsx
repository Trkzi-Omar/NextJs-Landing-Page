...
const Home: NextPage = () => {
    return (
        <div id={'Home'} className={'home w-screen flex flex-col flex-nowrap justify-start '}>
            <div className={'home-text-upper w-screen md:mb-12'}>
                <div className={'home-text-upper-left block pt-6 pl-10 pr-24' +
                    ...
                    <p className={'paragraph-text md:w-2/3'}>Est qu&rsquo;il possède une distribution de lettres plus ou moins
                        normale, et en tout cas comparable avec celle du français standard. De nombreuses suites
                    ...
                    <div className={'buttons hidden md:flex float-left flex-wrap justify-start pt-14'}>
                        ...
                        <div
                            ...
                            <a className={'p-0 m-0 w-min whitespace-nowrap group-hover:font-extrabold'}>Learn more</a>
                        </div>
                    </div>
                </div>
                ...
                <div className={'home-text-lower-right md:w-1/2 flex flex-wrap flex-row justify-end pr-32'}>
                    ...
                    <div className={'hidden paragraph md:inline-block'}>
                        ...
                        <p className={'paragraph-text'}>Est qu&apos;il possède une distribution de lettres plus ou moins
                            normale, et en tout cas comparable avec celle du français standard. De nombreuses suites
                            logicielles de mise en page ou éditeurs de sites Web ont fait du Lorem Ipsum leur faux texte
                            par défaut, et une recherche pour &apos;Lorem Ipsum&apos; vous conduira vers de nombreux
                        </p>
                    </div>
                </div>
            </div>
